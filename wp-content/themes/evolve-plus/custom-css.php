...
if($evolve_menu_submenu_font_icon == 'plus'){
    $evolve_css_data .= 'ul.nav-menu .sf-with-ul:after, 
...
if( ($evolve_custom_font_woff['url'] !="") && ( $evolve_custom_font_svg['url'] !="") && ($evolve_custom_font_eot['url'] !="" ) && ($evolve_custom_font_ttf['url'] !="" )){ 
	...
	src:
		url("'.$evolve_custom_font_eot['url'].'?#iefix") format("eot"),
		url("'.$evolve_custom_font_woff['url'].'") format("woff"),
		url("'.$evolve_custom_font_ttf['url'].'") format("truetype"),
		url("'.$evolve_custom_font_svg['url'].'#CustomFont") format("svg");
    font-weight: 400;
    font-style: normal;
}	
...
';
        ...
        // url('. $evolve_custom_font_woff['url'] .') format("woff"),
        // url('. $evolve_custom_font_ttf['url'] .') format("truetype"),
        // url('. $evolve_custom_font_svg['url'] . '"#Roboto") format("svg");
        // }
        // ';
...
$evolve_css_data .= '.page-title-container{
					border-color:#'.$Separator.';	
					}';

$page_title_bar_bg = get_post_meta($post_id, 'pyre_page_title_bar_bg', true);
...
if(isset($page_title_bar_bg)):
	...
	$evolve_css_data .='.page-title-container{
	 ...
	 /*?><?php if(get_post_meta($post_id, 'pyre_page_title_bar_bg_color', true)): ?>
	.page-title-container{
		background-color:<?php echo get_post_meta($post_id, 'pyre_page_title_bar_bg_color', true); ?>;
	}
	...
	.page-title-container{
		...
		<?php if(get_post_meta($post_id, 'pyre_page_title_bar_bg_full', true) == 'yes'): ?>
		-webkit-background-size: cover;
		-moz-background-size: cover;
		-o-background-size: cover;
		background-size: cover;
		<?php elseif(get_post_meta($post_id, 'pyre_page_title_bar_bg_full', true) == 'no'): ?>
		...
		<?php if(get_post_meta($post_id, 'pyre_page_title_bg_parallax', true) == 'yes'): ?>
		background-attachment: fixed;
		background-position:top center;
		<?php elseif(get_post_meta($post_id, 'pyre_page_title_bg_parallax', true) == 'no'): ?>
		background-attachment: scroll;
		<?php endif; ?>

	}
    
    	<?php if(get_post_meta($post_id, 'pyre_page_title_height', true)): ?>
	.page-title-container{
		height:<?php echo get_post_meta($post_id, 'pyre_page_title_height', true); ?>;    
	}
    ...
    <?php if(get_post_meta($post_id, 'pyre_page_title_bar_bg_retina', true)): ?>
	@media only screen and (-webkit-min-device-pixel-ratio: 2), only screen and (min-device-pixel-ratio: 2) {
		.page-title-container {
			background-image: url(<?php echo get_post_meta($post_id, 'pyre_page_title_bar_bg_retina', true); ?>);      
			-webkit-background-size:cover;
			   -moz-background-size:cover;
			     -o-background-size:cover;
			        background-size:cover;
