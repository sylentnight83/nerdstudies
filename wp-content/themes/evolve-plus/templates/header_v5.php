                ...
                <?php } else { ?>
                    <div class="primary-menu">
                        ...
                        if (has_nav_menu('primary-menu')) {
                            ...
                            wp_nav_menu(array('theme_location' => 'primary-menu', 'menu_class' => 'nav-menu', 'after'=> '<span class="slash">/</span>',
	                       'fallback_cb' => 'wp_page_menu', 'walker' => new evolve_Walker_Nav_Menu()));
                        } else {
                            ?>
