...
.woocommerce-menu .cart > a .t4p-icon-cart::before, .woocommerce-menu .my-account > a .t4p-icon-user::before{
    margin-right: 10px;
}
...
#righttopcolumn, #social, .sc_menu, .header a, #tagline, #logo{display:block;}
';
