    ...
    if ( ! class_exists( 'ReduxFramework_repeater' ) ) {
        ...
        class ReduxFramework_repeater {
            ...
            public function enqueue() {
                ...
                wp_enqueue_script(
                    "redux-field-{$this->extension->field_name}",
                    apply_filters( "redux/{$this->extension->field_name}/{$this->parent->args['opt_name']}/enqueue/redux-field-{$this->extension->field_name}-js", "{$this->extension->_extension_url}{$this->extension->field_name}/field_{$this->extension->field_name}{$min}.js" ),
                ...
                wp_enqueue_style(
                    "redux-field-{$this->extension->field_name}",
                    apply_filters( "redux/{$this->extension->field_name}/{$this->parent->args['opt_name']}/enqueue/redux-field-{$this->extension->field_name}-css", "{$this->extension->_extension_url}{$this->extension->field_name}/field_{$this->extension->field_name}.css" ),
                    array(),
                    time(),
                    'all'
                );
