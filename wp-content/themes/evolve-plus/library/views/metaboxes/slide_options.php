...
<div class="video_settings" style="display: none;">
	...
	$this->text(	'youtube_id',
					'Youtube Video ID',
					'For example the Video ID for http://www.youtube.com/RZRyQT1qedE is RZRyQT1qedE'
				);
	$this->text(	'vimeo_id',
					'Vimeo Video ID',
					'For example the Video ID for http://vimeo.com/78439312 is 78439312'
				);
...
$this->textarea('button_1',
				'Button #1<br/><a href="https://theme4press.com/docs/shortcodes/buttons/">Click here to view button option descriptions.</a>',
...
$this->textarea('button_2',
				'Button #2<br/><a href="https://theme4press.com/docs/shortcodes/buttons/">Click here to view button option descriptions.</a>',
