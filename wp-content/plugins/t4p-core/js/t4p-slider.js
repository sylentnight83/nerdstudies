jQuery(document).ready(function() {
	...
	jQuery(container).find('#pyre_slide_link, #pyre_button_1, #pyre_button_2').parents('.pyre_metabox_field').hide();

	if(type == 'button') {
		jQuery(container).find('#pyre_button_1, #pyre_button_2').parents('.pyre_metabox_field').show();
	} else {
		jQuery(container).find('#pyre_slide_link').parents('.pyre_metabox_field').show();
	}
