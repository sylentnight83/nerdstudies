...
class T4PSC_T4PSlider {
    ...
    function render_parent( $args, $content = '') {
        ...
        if ('evolve Plus' == $theme->name || 'evolve Plus' == $theme->parent_theme) { ?>
            <div class="t4p-slider-container <?php echo $slider_class; ?>-container" style="max-width:<?php echo $slider_settings['slider_width']; ?>;">
				<div class="t4p-slider-shortcode t4p-slider t4press-flexslider main-flex<?php echo $slider_class; ?>" style="max-width:<?php echo $slider_settings['slider_width']; ?>;" <?php echo $slider_data; ?>>
		<?php }else{ ?>
