...
class T4PSC_FlipBoxes {
	...
	function render_parent( $args, $content = '') {
		...
		$html = sprintf( '<div %s>%s</div><div %s></div>', T4PCore_Plugin::attributes( 'flip-boxes-shortcode' ), do_shortcode( $content ), T4PCore_Plugin::attributes( 't4p-clearfix' ) );
	...
	function parent_attr() {
		...
		$attr['class'] = 't4p-flip-boxes flip-boxes row';
